...
REVOKE ALL ON TABLE public.auction_rounds FROM PUBLIC, anon, authenticated, service_role;
...
ALTER TABLE public.public_metrics_consent ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON TABLE public.public_metrics_consent FROM PUBLIC, anon, authenticated, service_role;
